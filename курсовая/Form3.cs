...
namespace курсовая
{
    public partial class Form3 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            listBox1.Items.AddRange(WrapArray(array, 35));
            ...
            listBox2.Items.AddRange(WrapArray(sortedArray, 35));

            // Выводим метрики в label5, label6, label7
        ...
        private string[] WrapArray(int[] array, int charsPerLine)
        {
            string fullLine = string.Join(" ", array);
            List<string> lines = new List<string>();

            for (int i = 0; i < fullLine.Length; i += charsPerLine)
            {
                int length = Math.Min(charsPerLine, fullLine.Length - i);
                lines.Add(fullLine.Substring(i, length));
            }
